...
class ItemList extends Component {
    ...
    add(index, item = {}){
        if(!this.props.readOnly){
           this.props.arrayInsert('billingCycleForm', this.props.field, index, item) // create a new field in my form (dynamic)
        }
    }

    remove(index){
        if(!this.props.readOnly && this.props.list.length > 1){
            this.props.arrayRemove('billingCycleForm', this.props.field, index); //remove the field in dynamic form from array manipulation
        }
    }
